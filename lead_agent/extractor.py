...
SYSTEM_PROMPT = (
    ...
    "leadership must only be people who work AT this company (founders, "
    "executives, team members) — never a customer, client, investor, or "
    "partner who is merely quoted or named in a testimonial, case study, or "
    "'customers' page. A quote praising the product, attributed to someone "
    "with a title at a DIFFERENT company, is evidence of a customer, not a "
    "leader here; leave leadership empty rather than include that person. "
    "Set data_confidence to your own honest estimate (0.0-1.0) of how "
    "complete and reliable this specific extraction is — e.g. low if the "
    "pages barely mention leadership or contact info, high if the "
    "about/contact pages were thorough and unambiguous."
)
